          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              >
                ...
                <div className="text-center">
                  <div className="text-2xl font-bold text-gray-900 mb-1">$2.4B</div>
                ...
                <div className="bg-white/90 backdrop-blur-sm rounded-2xl p-6 border border-gray-200 shadow-xl">
                  <div className="flex items-center justify-between mb-6">
                    <div className="flex items-center">
                      ...
                      <div>
                        <h3 className="text-gray-900 font-semibold text-lg">Live Trading</h3>
                        <p className="text-gray-600 text-sm">Real-time Data</p>
                      </div>
                    </div>
                  ...
                  <div className="space-y-3">
                    <div className="flex justify-between items-center p-3 bg-gray-50 rounded-lg border border-gray-200">
                      <div className="flex items-center">
                        ...
                        <span className="font-medium text-gray-900">EUR/USD</span>
                      </div>
                      <div className="text-right">
                        <div className="text-gray-900 font-semibold">1.0845</div>
                        <div className="text-green-600 font-medium text-sm">+0.23%</div>
                      </div>
                    </div>
                    <div className="flex justify-between items-center p-3 bg-gray-50 rounded-lg border border-gray-200">
                      <div className="flex items-center">
                        ...
                        <span className="font-medium text-gray-900">GBP/USD</span>
                      </div>
                      <div className="text-right">
                        <div className="text-gray-900 font-semibold">1.2654</div>
                        <div className="text-red-600 font-medium text-sm">-0.15%</div>
                      </div>
                    </div>
                  </div>
                </div>
