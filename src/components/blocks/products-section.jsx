...
const ProductsSection = ({ language = 'th' }) => {
  ...
  const translations = {
    th: {
      ...
      description: 'เลือกจากผลิตภัณฑ์การเทรดที่หลากหลายและมีคุณภาพสูง',
      categories: {
        all: 'ทั้งหมด',
        forex: 'Forex',
        crypto: 'Crypto',
    ...
    en: {
      ...
      description: 'Choose from a wide range of high-quality trading products',
      categories: {
        all: 'All',
        forex: 'Forex',
        crypto: 'Crypto',
  ...
  return (
    <section className="py-8 sm:py-12 lg:py-16 bg-gradient-to-br from-red-900 via-black to-red-800 relative overflow-hidden">
      ...
      <div className="container mx-auto px-3 sm:px-4 relative z-10">
        ...
        >
          ...
          <motion.h2 
            ...
            viewport={{ once: true }}
            className="text-2xl sm:text-3xl lg:text-4xl font-bold text-white mb-3 sm:mb-4 leading-tight"
          >
            {t.title}
          </motion.h2>
          <motion.p 
            ...
            viewport={{ once: true }}
            className="text-sm sm:text-base text-gray-300 max-w-2xl mx-auto leading-relaxed px-2"
          >
            {t.description}
          </motion.p>
        </motion.div>
        ...
        >
          <div className="bg-black/50 backdrop-blur-sm rounded-2xl p-2 shadow-lg border border-red-500/30">
        ...
        <div className="relative max-w-6xl mx-auto">
          ...
          <button
            ...
            className="absolute left-2 sm:left-4 top-1/2 -translate-y-1/2 z-20 w-8 h-8 sm:w-10 sm:h-10 bg-black/50 hover:bg-black/70 backdrop-blur-sm rounded-full flex items-center justify-center text-white transition-colors duration-200 shadow-lg border border-red-500/30"
          >
          ...
          <button
            ...
            className="absolute right-2 sm:right-4 top-1/2 -translate-y-1/2 z-20 w-8 h-8 sm:w-10 sm:h-10 bg-black/50 hover:bg-black/70 backdrop-blur-sm rounded-full flex items-center justify-center text-white transition-colors duration-200 shadow-lg border border-red-500/30"
          >
                      ...
                      <div className={`w-full h-full transform-style-preserve-3d transition-transform duration-700 shadow-lg shadow-black/50 rounded-lg ${hoveredProduct === productKey ? 'rotate-y-180' : ''}`}>
                        ...
                        <div className="absolute inset-0 bg-gray-900 backface-hidden rounded-lg overflow-hidden">
                          <div className="absolute inset-0 p-3 sm:p-4 flex flex-col justify-between">
                            ...
                            {/* Description */}
                            <div className="bg-black/80 backdrop-blur-sm p-3 sm:p-4 rounded-lg shadow-lg">
                              ...
                              <div className="text-xs text-gray-400">
                                {language === 'th' ? 'ตลาด 24/7' : '24/7 Market'} &nbsp; | &nbsp; {language === 'th' ? 'สเปรดต่ำ' : 'Low Spread'}
                              </div>
                            </div>
                          </div>
        ...
        >
          <div className="inline-flex flex-row items-center space-x-4 sm:space-x-6 lg:space-x-8 bg-black/50 backdrop-blur-sm rounded-xl px-4 sm:px-6 py-3 sm:py-4 shadow-lg border border-red-500/30">
